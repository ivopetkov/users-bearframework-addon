...
ivoPetkov.bearFrameworkAddons.users=ivoPetkov.bearFrameworkAddons.users||function(){var e=!1;EventTarget=window.EventTarget||function(){var a={};this.addEventListener=function(b,d){"undefined"===typeof a[b]&&(a[b]=[]);a[b].push(d)};this.removeEventListener=function(b,d){if("undefined"!==typeof a[b])for(var c=a[b],f=0;f<c.length;f++)if(c[f]===d){c.splice(f,1);break}};this.dispatchEvent=function(b){if("undefined"===typeof a[b.type])return!0;for(var d=a[b.type],c=0;c<d.length;c++)d[c].call(this,b);return!b.defaultPrevented}};
var h=function(a){if("function"===typeof Event)return new Event(a);var b=document.createEvent("Event");b.initEvent(a,!1,!1);return b},k=function(){var a=document.querySelector(".ivopetkov-users-badge");a&&a.parentNode.removeChild(a)},g=new EventTarget;return{currentUser:{exists:function(){return e},addEventListener:function(a,b){g.addEventListener(a,b)},removeEventListener:function(a,b){g.removeEventListener(a,b)}},initialize:function(a){e="undefined"!==typeof a?0<a:!1},login:function(a){clientShortcuts.get("lightbox").then(function(b){b.wait(function(b){clientShortcuts.get("serverRequests").then(function(c){c.send("ivopetkov-users-login",

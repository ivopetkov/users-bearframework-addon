...
id:c};clientShortcuts.get("serverRequests").then(function(b){b.send("ivopetkov-users-preview-window",d).then(function(b){b=JSON.parse(b);"undefined"!==typeof b.html&&a.open(b.html)})})})})}}}();